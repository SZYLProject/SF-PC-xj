            ...
            <el-form :inline="true" ref="form" :model="formDataDis" class="">
              ...
              <div>
                <el-form-item label="姓名" class="inline_form-item">
                  <span>{{ formDataDis.patientName }}</span>
                </el-form-item>
              </div>
              <el-row>
                <el-col :span="8">
...
export default {
  ...
  created() {
    // console.log('姓名',this.formDataDis)
    this.getCode2();
    this.getCode3();
  },
  methods: {
    ...
    cklickTimeLine(timeLineItem, index) {
      ...
      // if (timeLineItem.groupId == this.$route.query.groupId && this.$route.query.statusNum != 1) {
