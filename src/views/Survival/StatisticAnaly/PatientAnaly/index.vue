<template>
  <div class="patientAnalyContent content">
    <div class="analy-basic">
      <el-row :gutter="16" class="nav-numlist">
        <el-col :span="6">
          <div class="grid-content total-people">
            ...
            <!-- <div class="total-num-value-right">
              <p class="name-num">关注微信</p>
              <p class="value-num" style="color: #fd4e71">
                {{ analysis.wechat }}
              </p>
            </div> -->
        ...
        <el-col :span="18" class="card-panel">
          <el-col :span="4">
          ...
          <el-col :span="4">
            <div class="grid-content stable-patient">
              <p>
                ...
                <span class="percentage" style="color: #6caae3">{{
                  analysis.stablePercent + "%"
                }}</span>
              </p>
          ...
          <el-col :span="4">
            <div class="grid-content relapsed-patients">
              <p>
                ...
                <span class="percentage" style="color: #eb9962">{{
                  analysis.relapsePercent + "%"
                }}</span>
              </p>
          ...
          <el-col :span="4">
            <div class="grid-content lost-to-follow-up">
              <p>
                ...
                <span class="percentage" style="color: #ae9ee6">{{
                  analysis.lostPercent + "%"
                }}</span>
              </p>
          ...
          <el-col :span="4">
            <div class="grid-content dead-patient">
              <p>
                ...
                <span class="percentage" style="color: #988ec6">{{
                  analysis.deathPercent + "%"
                }}</span>
              </p>
    ...
    <div class="echart-box">
      ...
      <el-row>
        <el-col :span="24" class="echart-grid relative">
          <span class="echart-tit"> 地域分布 </span>
          <div class="regionValueBtn">
            <el-radio-group
              v-model="regionValue"
              size="mini"
              @change="regionValueChange"
            >
...
// import "../../../../../node_modules/echarts/map/js/province/xinjiang.js"; // 引入中国地图数据
require("echarts/map/js/china.js"); // 引入中国地图数据
require("echarts/map/js/province/xinjiang.js"); // 引入新疆地图数据
...
export default {
  ...
  created() {
    ...
    // this.getSourcePatientsFn(); // 患者来源接口
    ...
    this.getInfoByLocalFn(); // 地域分布接口-全国
    this.getXJInfoByLocalFn();// 地域分布接口-新疆
  },
  methods: {
    //癌种时间查询
    search() {
    ...
    showGenderDistribution(echartData) {
      // console.log(echartData,'echartDataechartData',echartData.manPercent)
      // echartData.manPercent =echartData.manPercent.toFixed(2)


      //   console.log(echartData,'BBBBBBBBBBBBBB',echartData.manPercent)
      this.$nextTick(() => {
          ...
          series: [
            {
              ...
              label: {
                ...
                formatter: function (item) {
                  let val =
                    item.name === "男" ? echartData.iSman : echartData.iSwoman;
                  let percent =
                    item.name === "男"
                      ? echartData.manPercent
                      : echartData.womanPercent
                  return (
                    val +
                    ", " +
                    percent
    ...
    regionValueChange(val) {
      console.log(val);
      if (val == "新疆") {
        this.$nextTick(() => {
          this.xjMapEchartFn(this.xinJiangDataList);
        });
      } else {
        this.$nextTick(() => {
          this.showGeographicalDistribution(this.chinaDataList);
        });
      }
    },
    // 全国地图数据分布
    ...
    getXJInfoByLocalFn() {
      getXJInfoByLocal()
        .then((res) => {
          this.xinJiangDataList = res.data;
        })
        .catch((err) => {});
    },
    // 新疆分部
