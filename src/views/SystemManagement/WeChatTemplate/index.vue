  ...
  <div class="content">
    ...
    <div class="page-table">
      ...
      >
        ...
        <el-table-column prop="typeName" label="随访类型"></el-table-column>
        <el-table-column
          prop="content"
          label="模板内容"
...
import {
  weChatTemplateGetAll,
  weChatTemplateAdd,
  weChatTemplateUpdate,
  weChatTemplateDel,
} from "@/api/weChatTemplate";
export default {
  name: "WeChatTemplate",
  data() {
    return {
  ...
  methods: {
    ...
    changeModel(val) {
      ...
      this.dialogTitle = "编辑微信模板";
    },
    //确定
    determine() {
      // 新增
      if (this.dialogTitle === "新建微信模板") {
        this.$refs.dataForm.validate((valid) => {
          if (valid) {
            weChatTemplateAdd(this.dataForm)
              .then((res) => {
      ...
      } else if (this.dialogTitle === "编辑微信模板") {
        weChatTemplateUpdate(this.dataForm)
          .then((res) => {
