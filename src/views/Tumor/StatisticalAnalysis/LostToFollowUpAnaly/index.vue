<template>
	<div class="LostToFollowUpAnalyContent content">
		<div class="query-result">
			<div class="buttons">
				<span class="title">登记随访失访情况分析</span>
				<!-- <span class="echart-tit"> 登记随访失访情况分析 </span>  -->
				...
				<div class="fr" style="margin-right: 20px;">
					<el-select v-model="value" placeholder="选择项目" multiple collapse-tags size="mini">
					    <el-option
...
import { findProjectList,analysisLostVisits,downloadLostData } from "@/api/tumor/tumorFollowup";
	export default {
        ...
        this.loading = true
			...
			down(){
				downloadLostData(this.value).then((res) => {
					...
					downloadElement.download = "登记随访失访情况分析"+ timeNow + ".xlsx"; // 下载后文件名
