...
export default {
  ...
  methods: {
    ...
    getStaticByRegisterFn() {
      getStaticByRegister()
        .then((res) => {
          console.log(res, "getStaticByRegistergetStaticByRegister");
          this.deathCount = res.data.deathCount;
          this.lostCount = res.data.lostCount;
          this.relapseCount = res.data.relapseCount;
          this.stableCount = res.data.stableCount;
          this.totalCount = res.data.totalCount;
          this.toFollowCount = res.data.toFollowCount;
          // this.transferCount = res.data.transferCount;
        })
        .catch((error) => {
          console.error(error);
        });
